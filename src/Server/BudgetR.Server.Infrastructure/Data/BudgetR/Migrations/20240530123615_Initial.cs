    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Users_BusinessTransactionActivities_BusinessTransactionActivityId",
                    column: x => x.BusinessTransactionActivityId,
                    principalTable: "BusinessTransactionActivities",
                    principalColumn: "BusinessTransactionActivityId");
                table.ForeignKey(
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[] { 1L, new DateTime(2024, 5, 30, 6, 36, 14, 676, DateTimeKind.Local).AddTicks(5261), "Initial Seeding", 1L });
        ...
        migrationBuilder.CreateIndex(
            name: "IX_Users_BusinessTransactionActivityId",
            table: "Users",
            column: "BusinessTransactionActivityId");
